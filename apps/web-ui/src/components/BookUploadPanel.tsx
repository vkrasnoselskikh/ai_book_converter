...
export const BookUploadPanel: React.FC<BookUploadPanelProps> = ({
  ...
  const validateAndUpload = (file: File) => {
    ...
    if (suffix !== ".epub" && suffix !== ".djvu") {
      setLocalError("Unsupported format. Please upload an EPUB or DJVU book.");
      return;
    }
        ...
        {isUploading ? (
          <div className="flex flex-col items-center gap-4 animate-fade-in">
            ...
            <div className="flex flex-col gap-1">
              <p className="font-semibold text-lg text-base-content">Uploading Book...</p>
              <p className="text-sm text-base-content/60">Extracting content and initiating AI processing pipeline</p>
            </div>
          </div>
        ) : (
          <div className="flex flex-col items-center gap-4 transition-transform group-hover:scale-[1.02]">
            ...
            <div className="flex flex-col gap-1.5">
              <p className="font-heading font-extrabold text-xl">Drag & drop your book here</p>
              <p className="text-sm text-base-content/60">Supports EPUB or DJVU files up to 100MB</p>
            </div>
